...
const Services = () => {
    ...
    const servicesContent = {
        subtitle: 'OUR LOAN PRODUCTS',
        title: 'CHECK OUT SOME OF THE PRODUCTS WE OFFER',
        btn_text: 'ALL LOAN PRODUCTS',
        btn_link: '/services'
    }
    return (
                    ...
                    {servicesItem?.map((data, id) => (
                        <div className="col-xl-3 col-lg-4 col-md-6 mt-25" key={id}>
                            <div className="services__one-item">
                                ...
                                <p>Read More<i className="far fa-chevron-double-right"></i></p>
                            </div>
                        </div>
                    ))}
                </div>
